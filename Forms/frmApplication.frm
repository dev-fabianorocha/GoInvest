...
Begin VB.Form frmApplication 
   ...
   Begin VB.Frame quadBotoes 
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":7AD5
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         Height          =   855
         Index           =   1
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":8DA1
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         Height          =   855
         Index           =   4
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":A06F
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         Height          =   855
         Index           =   5
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":B33A
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         Height          =   855
         Index           =   2
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":C605
      End
      Begin fpBtnAtlLibCtl.fpBtn cmdOpcao 
         Height          =   855
         Index           =   3
         ...
         DropShadowColor =   4210752
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":D8D1
      End
   End
   Begin VB.Frame quadCadastro 
      ...
      Begin VB.Frame quadInvestimento 
         ...
         Begin FPSpreadADO.fpSpread gridAplicacoes 
            ...
            ShadowDark      =   8421504
            ShadowText      =   0
            SpreadDesigner  =   "frmApplication.frx":EB9D
            UserResize      =   0
         End
         Begin fpBtnAtlLibCtl.fpBtn cmdLimparAplicacoes 
            ...
            DropShadowColor =   0
            Redraw          =   -1  'True
            ButtonDesigner  =   "frmApplication.frx":121CE
         End
         Begin fpBtnAtlLibCtl.fpBtn cmdAplicar 
            ...
            DropShadowColor =   0
            Redraw          =   -1  'True
            ButtonDesigner  =   "frmApplication.frx":134A7
         End
      ...
      Begin FPSpreadADO.fpSpread gridSimulacao 
         ...
         ShadowDark      =   8421504
         ShadowText      =   0
         SpreadDesigner  =   "frmApplication.frx":14777
         UserResize      =   0
      End
      Begin VB.Label Label 
         BackColor       =   &H00E0E0E0&
   ...
   Begin VB.Frame quadPesquisa 
      ...
      Begin fpBtnAtlLibCtl.fpBtn cmdPesquisa 
         ...
         DropShadowColor =   0
         Redraw          =   -1  'True
         ButtonDesigner  =   "frmApplication.frx":14C62
      End
      ...
      Begin FPSpreadADO.fpSpread gridPrincipal 
         ...
         ShadowDark      =   8421504
         ShadowText      =   0
         SpreadDesigner  =   "frmApplication.frx":15F39
         UserResize      =   0
      End
      Begin VB.Label Label 
         BackColor       =   &H00E0E0E0&
...
With fClsExtrato
    For sCont = 1 To gridAplicacoes.MaxRows
        ...
        If fOpcao = EnumOption.Update Or fOpcao = EnumOption.eInclude Then
            fClsExtrato.CodigoAplicacao = VariableAdjust(fCodigo, eDoubleNumber)
